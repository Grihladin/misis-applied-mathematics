...
| Area | Project | What it explored |
| --- | --- | --- |
| Artificial intelligence | [Rasa commerce assistant](artificial-intelligence/rasa-commerce-assistant) | Intent recognition, dialogue flows, custom actions, forms, and SQLite-backed order operations |
| Computer graphics | [3D cube rotation](computer-graphics/3d-cube-rotation) | Rotation and projection matrices rendered with NumPy and Pygame, plus an OpenGL experiment |
| Discrete mathematics | [Red-black tree](discrete-mathematics/red-black-tree) | A template-based self-balancing tree in C++ with terminal visualization |
| Machine learning | [Music genre classifier](machine-learning/music-genre-classifier) | MFCC feature extraction and a TensorFlow neural-network classifier |
